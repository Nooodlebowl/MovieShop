...
namespace Infrastructure.Data
{
    public class MovieShopDbContext : DbContext
    {
        ...
        {
            //can specify the fluent API way
        ...
        private void ConfigurePurchase(EntityTypeBuilder<Purchase> builder)
        {
            ...
            builder.Property(r => r.PurchaseDateTime).HasDefaultValueSql("getdate()");
            builder.HasIndex(r => r.PurchaseNumber).IsUnique();
            builder.Property(r => r.TotalPrice).HasColumnType("decimal(5, 2)");
        ...
        {
            //can view the rules for our movie entity
            ...
            //999.99 5total 2after the point
            ...
            //puts nonclustered indexs on freq read cols
